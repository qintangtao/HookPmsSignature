...
public class ServiceManagerWraper {
    ...
    public static void hookPMS(Context context, String signed, String appPkgName){
        try{
            ...
            Object proxy = Proxy.newProxyInstance(
                    ...
                    new PmsHookBinderInvocationHandler(sPackageManager, signed, appPkgName));
    ...
    public static void hookPMS(Context context){
    	...
    	hookPMS(context, qqSign, "com.tencent.mobileqq");
    }
